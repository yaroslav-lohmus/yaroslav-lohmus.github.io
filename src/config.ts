...
export const FooterDescription = 'TODO: Add footer description';
...
export const Socials: Record<string, Record<string, string>> = {
	...
	github: { url: 'https://github.com/yaroslav-lohmus/' },
	...
	// rss: { url: '/rss.xml' },
	linkedin: { url: 'https://www.linkedin.com/in/yaroslav-ishanov/' },
};
